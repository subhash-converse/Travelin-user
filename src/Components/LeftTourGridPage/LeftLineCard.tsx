...
import topPick2 from "../../Assets/Images/HomeImage/TopPick2.jpg"
...
const LeftLineCard = (props:data) => {
  return (
    <div className=' grid grid-cols-1 md:grid-cols-3 gap-4 last-deal card-hover card-line  bg-white main-input p-7'>
        <div>
            <img src={topPick2} alt="tourpic" className='rounded-xl w-full h-full' />
        </div>
        <div>
            <p className='text-[#777777] text-[13px]'>6+ Hours | Full Day Tours </p>
            <h2 className='Play-fair text-[26px] text-[#17233E] pb-[8px]'>Leeds Castle, Cliffs Of Dover</h2>
            <div>
                <div>
