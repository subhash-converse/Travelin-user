...
<div  className='fix-image h-[354px] w-full relative ' >
    ...
    <div className='absolute top-[40%] ld:top-[25%] flex justify-center w-full'>
        ...
        <h3 className='flex gap-2 justify-center'><span>Home</span><span>|</span><span>Tour Grid Leftside</span></h3>
        </div>
    </div>
    <div className=''>
        <div className='flex  absolute bottom-[-1px]'>
            <img className=' rotate w-[33.34%]' src={mountain} alt="mountain" />
            <img className='relative left-[-1px] rotate w-[33.33%]' src={mountain} alt="mountain" />
            <img className='relative left-[-3px] rotate w-[33.48%]' src={mountain} alt="mountain" />
        </div>
    </div>
</div>
</>  )
