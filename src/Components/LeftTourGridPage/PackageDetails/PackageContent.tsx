...
const PackageContent = () => {
  return (
    <div className="w-full   ">
      <div className="max-w-[1290px] px-[15px] lg:flex mx-auto pt-[48px]">
        <div className="w-full lg:w-[65%] px-[15px] ">
          ...
          {/* map */}
          <h1 className="text-[22px] mb-4 mt-6 text-[black] Play-fair">Map</h1>
          <div>
            <iframe
          ...
          {/* reviews */}
          <h1 className="text-[22px] mb-4 mt-6 text-[black] Play-fair">
            Average Reviews
          </h1>
          <div>
            <AverageReviews />
          ...
          {/*  review chats*/}
          <h1 className="text-[22px] pb-4 mb-4 mt-6  border-b border-dashed border-[] text-[black] Play-fair">
        ...
        <div className="w-full lg:w-[35%]">
          <div className="pl-[24px]  sticky top-[150px]">
            <h2 className="package-index">Highlight</h2>
            <h2 className="package-index">Iternary</h2>
            <h2 className="package-index">Reviews</h2>
            <h2 className="package-index">Comments</h2>
            <h2 className="package-index">Add Reviews</h2>
          </div>
        </div>
      </div>
      <div>
