...
const GetToKnowUs = () => {
  return (
    <div>
      <div >
        <div className="w-full flex justify-center p-4 pt-12 background-travelers" style={{ backgroundImage: `url(${peoples})` }}>
          <div className="lg:max-w-[1200px] md:grid grid-cols-2"   >
            <div className="flex flex-col justify-end text-center lg:text-left">
              <h3 className="Play-fair text-[22px] text-[#777777]">Get To Know Us</h3>
              <h1 className="Play-fair text-[36px] lg:text-[46px] mb-4">Explore All Tour Of The World With Us.</h1>
